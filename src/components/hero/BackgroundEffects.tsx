...
export default function BackgroundEffects() {
  ...
  useEffect(() => {
    // HIGH-END DESKTOP: Premium vibrant color palette
    const colors = highEndAnimations ? [
      "rgba(57, 255, 20, 0.35)",   // Vibrant Loki Green (brighter)
      "rgba(120, 255, 68, 0.3)",   // Bright Green (more vibrant)
      "rgba(35, 192, 25, 0.25)",   // Deep Green (richer)
      "rgba(200, 255, 100, 0.2)",  // Lime Green (premium)
      "rgba(0, 150, 50, 0.2)",      // Forest Green (depth)
      "rgba(57, 255, 20, 0.4)",    // Extra vibrant
    ] : [
    ...
    // HIGH-END DESKTOP: More orbs with larger sizes for richer background
    const orbCount = highEndAnimations ? 16 : 8;
    orbs.current = [...Array(orbCount)].map(() => ({
      x: Math.random() * 100,
      y: Math.random() * 100,
      size: highEndAnimations ? Math.random() * 150 + 50 : Math.random() * 120 + 40, // Larger on desktop
    ...
    <>
      <div className="absolute inset-0 -z-10">
        ...
        <motion.div 
          ...
          animate={{ 
            scale: highEndAnimations ? [1, 1.1, 1] : [1, 1.05, 1],
      ...
      <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: highEndAnimations && (orb.color.includes("rgba(57, 255, 20") || orb.color.includes("rgba(120, 255, 68"))
                ? "0 0 60px rgba(57, 255, 20, 0.6), 0 0 120px rgba(120, 255, 68, 0.3)"
            ...
            animate={{
              ...
              scale: highEndAnimations ? [1, i % 2 === 0 ? 1.2 : 0.95, 1] : [1, i % 2 === 0 ? 1.1 : 0.9, 1]
            }}
            transition={{
              repeat: Infinity,
              duration: 5 + i,
        ...
        <motion.div
          ...
          style={{ 
            top: "30%", 
            boxShadow: highEndAnimations ? "0 0 25px #39ff14, 0 0 50px rgba(120,255,68,0.5)" : "0 0 15px #39ff14",
            background: highEndAnimations
              ? "linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(57,255,20,0.6) 30%, rgba(120,255,68,0.9) 50%, rgba(57,255,20,0.6) 70%, rgba(0,0,0,0) 100%)"
        ...
        <motion.div
          ...
          style={{ 
            top: "70%", 
            boxShadow: highEndAnimations ? "0 0 20px #39ff14, 0 0 40px rgba(120,255,68,0.4)" : "0 0 12px #39ff14",
            background: highEndAnimations
              ? "linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(57,255,20,0.5) 30%, rgba(120,255,68,0.8) 50%, rgba(57,255,20,0.5) 70%, rgba(0,0,0,0) 100%)"
        ...
        <motion.div
          ...
          animate={{
            ...
            borderColor: highEndAnimations
              ? ["rgba(57, 255, 20, 0.4)", "rgba(120, 255, 68, 0.8)", "rgba(57, 255, 20, 0.4)"]
        ...
        <motion.div
          ...
          animate={{
            rotate: [360, 0],
            borderColor: highEndAnimations
              ? ["rgba(57, 255, 20, 0.5)", "rgba(120, 255, 68, 0.9)", "rgba(57, 255, 20, 0.5)"]
